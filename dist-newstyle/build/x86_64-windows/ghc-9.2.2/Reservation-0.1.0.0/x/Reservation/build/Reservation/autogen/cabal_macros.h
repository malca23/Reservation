...
/* package Reservation-0.1.0.0 */
#ifndef VERSION_Reservation
#define VERSION_Reservation "0.1.0.0"
#endif /* VERSION_Reservation */
#ifndef MIN_VERSION_Reservation
#define MIN_VERSION_Reservation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Reservation */
...
#define CURRENT_COMPONENT_ID "Reservation-0.1.0.0-inplace-Reservation"
